...
public:
	...
	Q_INVOKABLE void pushMessageToUserList(const QString &dbId, const QString &eleId, const QString &operation,
...
private:
	...
	void pushMessageToSpecifiedUsers(const QString &papFormattedAddresses, QString& pushMessage);
